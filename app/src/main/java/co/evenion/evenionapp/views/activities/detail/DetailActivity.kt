...
import co.evenion.evenionapp.databinding.ActivityDetailBinding
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when(item?.itemId){
            R.id.delete -> {
                ...
                Toast.makeText(this, "Data  ${student.name} Deleted Successfully", Toast.LENGTH_LONG).show()
                finish()
            }
            R.id.edit -> {
                ...
                dialogBuilder.setTitle("Detail Update")
                ...
                dialogBuilder.setPositiveButton("Update") { _: DialogInterface, _: Int ->
                    ...
                    gender = when (selectedRadioButton) {
                        R.id.radio_female -> "Male"
                        else -> "Female"
                    }
                    viewModel.updateData(student.id, studentName.toString(), studentNim.toString(), gender)
                    Toast.makeText(this, "Data Updated Successfully $studentName ", Toast.LENGTH_LONG).show()
                }
